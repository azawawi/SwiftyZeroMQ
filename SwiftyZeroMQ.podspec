...
Pod::Spec.new do |s|
  ...
  s.ios.vendored_libraries     = "Sources/libzmq-ios.a"
  s.osx.vendored_libraries     = "Sources/libzmq-macos.a"
  s.tvos.vendored_libraries    = "Sources/libzmq-tvos.a"
  s.watchos.vendored_libraries = "Sources/libzmq-watchos.a"
